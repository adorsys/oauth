<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    ...
    <body ng-cloak ng-init="loginUrl = '${pageContext.request.contextPath}/j_security_check?${pageContext.request.queryString}'; loginError = ${requestScope.oauthloginerror == true}">
