...
//		String remoteIP = url.getProtocol()+"://"+url.getHost()+(url.getPort()>0?":"+url.getPort():"") + "/" + url.getPath(); 
		org.opensaml.saml2.core.Response authnResponse = generateAuthnResponse(assertionConsumerServiceURL, "diksadmin", "diksadmin",assertionConsumerServiceURL, 300, authnRequest.getID(), new DateTime());
