...
public class TestServlet {
    ...
    public static Archive createDeployment() {
        ...
        Archive archive = ShrinkWrap.create(WebArchive.class, "sample.war")
    ...
    public void testServlet() throws Exception {
        ...
        AccessTokenResponse tokenResponse = AccessTokenResponse.parse(JSONObjectUtils.parseJSONObject(json));
