...
public class FixedServletUtils {
	 ...
	 *
	 * @param servletRequest The servlet request. Must not be {@code null}.
	 *
	 ...
	 *                                  exception.
	 */
	public static HTTPRequest createHTTPRequest(final HttpServletRequest servletRequest, final long maxEntityLength) throws IOException {
